package com.mingyi.common.config;

import com.mingyi.common.utils.StringUtil;
import com.mingyi.common.utils.YamlUtil;
...
public class Global {
	...
	{
		return StringUtil.nvl(getConfig("ruoyi.version"), "3.2.0");
	}
	...
	{
		return StringUtil.nvl(getConfig("ruoyi.copyrightYear"), "2018");
	}
